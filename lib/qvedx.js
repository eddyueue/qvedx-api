...
parseCURLError = function(err,stdout,stderr){
    ...
    if(match){
        ...
        if(statusCode == 0){
            ...
            return {err: { type: "CURLE_COULDNT_RESOLVE_HOST", msg: msg, code: statusCode}};
        } else if(statusCode == 28){
            return {err: { type: "CURLE_OPERATION_TIMEDOUT", msg: msg, code: statusCode}};
        } else {
            return {err: { type: "UNKNOWN", msg: msg, code: statusCode}};
        }
    } else {
        return stderr;
    }
