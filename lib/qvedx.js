...
QVEDX.prototype.GetTimeLimitedServiceKey = function(options,callback){
	...
	QVEDX.prototype.GenericAPICall({
		...
		data: '<GetTimeLimitedServiceKey xmlns=\\\"http://ws.qliktech.com/QMS/11/\\\"/>'
	},callback);
}
...
QVEDX.prototype.Ping = function(options,callback){
	...
	QVEDX.prototype.GenericAPICall({
		soapAction: 'Ping',
		data: '<Ping xmlns=\\\"http://ws.qliktech.com/QMS/11/\\\"/></s:Body></s:Envelope>'
	},callback);
}
...
QVEDX.prototype.FindEDX = function(options,callback){
	...
	QVEDX.prototype.GenericAPICall({
		soapAction: 'FindEDX',
		data: '<FindEDX xmlns=\\\"http://ws.qliktech.com/QMS/11/\\\"><name>'+ options.name +'</name></FindEDX>'
	},callback);
}
...
QVEDX.prototype.GetEDXTaskStatus = function(options,callback){
	...
	QVEDX.prototype.GenericAPICall({
		...
		data: '<GetEDXTaskStatus xmlns=\\\"http://ws.qliktech.com/QMS/11/\\\"><qdsID>00000000-0000-0000-0000-000000000000</qdsID><executionID>'+options.executionID+'</executionID></GetEDXTaskStatus>'
	},callback);
}
...
QVEDX.prototype.GetTaskStatus = function(options,callback){
	...
	QVEDX.prototype.GenericAPICall({
		...
		data: '<GetTaskStatus xmlns=\\\"http://ws.qliktech.com/QMS/11/\\\"><taskID>'+options.taskID+'</taskID><scope>All</scope></GetTaskStatus>'
	},callback);
}
...
QVEDX.prototype.AbortTask = function(options,callback){
	...
	QVEDX.prototype.GenericAPICall({
		...
		data: '<AbortTask xmlns=\\\"http://ws.qliktech.com/QMS/11/\\\"><taskID>'+options.taskID+'</taskID></AbortTask>'
	},callback);
}
