...
QVEDX.prototype.GetDocumentMetaData = function(options,callback){
	if(!options.folderID){
		return callback({err: 'options.folderID not defined'});
	}	
	if(!options.documentID){
		return callback({err: 'options.documentID not defined'});
	}	

	var data = '<GetDocumentMetaData xmlns="http://ws.qliktech.com/QMS/11/"><userDocument xmlns:a="http://schemas.datacontract.org/2004/07/PIX.QMSAPI.DataObjects" xmlns:i="http://www.w3.org/2001/XMLSchema-instance"><a:FolderID>'+options.folderID+'</a:FolderID><a:ID>'+options.documentID+'</a:ID></userDocument><scope>Licensing</scope></GetDocumentMetaData>';


	//<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/"><s:Body><GetDocumentMetaData xmlns="http://ws.qliktech.com/QMS/11/"><userDocument xmlns:a="http://schemas.datacontract.org/2004/07/PIX.QMSAPI.DataObjects" xmlns:i="http://www.w3.org/2001/XMLSchema-instance"><a:FolderID>e10cc9cf-39e2-4752-93b3-4622f83d029c</a:FolderID><a:ID>d442645b-109a-fb5d-ef0d-6d852ca6a330</a:ID><a:IsOrphan>false</a:IsOrphan><a:IsSubFolder>false</a:IsSubFolder><a:Name>QV11SystemMonitor.qvw</a:Name><a:RelativePath/><a:TaskCount>0</a:TaskCount><a:Type>User</a:Type></userDocument><scope>Licensing</scope></GetDocumentMetaData></s:Body></s:Envelope>
	QVEDX.prototype.GenericAPICall({
