...
writeRequestLog = function(id,cmd){
	if(QVEDX.requestLog){
		cmd = cmd.replace(QVEDX.options.ntlm.password,'****');
...
var serviceTypes = {
	NONE: {value: 'None'},
	QMS: {value: 'QlikViewManagementService'},
	QDS: {value: 'QlikViewDistributionService'},
	QVS: {value: 'QlikViewServer'},
	DCS: {value: 'QlikViewDirectoryServiceConnector'},
	QVWS: {value: 'QlikViewWebServer'},
	RQMS: {value: 'RemoteQlikViewManagementService'},
	ALL: {value: 'All'}
}
...
function QVEDX(options){
	...
	QVEDX.RUN_STATUS = runStatus;
	QVEDX.TRIGGER_RESULTS = triggerResults;
	QVEDX.SERVICE_TYPES = serviceTypes;
};
...
QVEDX.prototype.GetTimeLimitedServiceKey = function (callback,options){
	...
	if(QVEDX.requestLog){
		fs.appendFileSync('request-log.log','' + new Date() + '\n' + cmd + '\n\n');
	}
	...
	child = exec(cmd, function (err, stdout, stderr) {
		...
		parseString(stdout, QVEDX.parserOptions, function (err, result) {
			...
			try {
				...
				if(soapResult){
					key = soapResult.GetTimeLimitedServiceKeyResponse.GetTimeLimitedServiceKeyResult;
...
QVEDX.prototype.Ping = function (callback){
	console.log("Ping");
...
QVEDX.prototype.TriggerEDXTask = function(options,callback){
	...
	QVEDX.prototype.GenericAPICall({
		...
		data: '<s:Envelope xmlns:s=\\\"http://schemas.xmlsoap.org/soap/envelope/\\\"><s:Body><TriggerEDXTask xmlns=\\\"http://ws.qliktech.com/QMS/11/\\\"><qdsID>00000000-0000-0000-0000-000000000000</qdsID><taskNameOrID>'+options.taskNameOrID+'</taskNameOrID><password>'+options.password+'</password><variableName i:nil=\\\"true\\\" xmlns:i=\\\"http://www.w3.org/2001/XMLSchema-instance\\\"/><variableValues i:nil=\\\"true\\\" xmlns:a=\\\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\\\" xmlns:i=\\\"http://www.w3.org/2001/XMLSchema-instance\\\"/></TriggerEDXTask></s:Body></s:Envelope>'
	},callback);
}
...
QVEDX.prototype.GetServices = function(options,callback){
	...
	QVEDX.prototype.GenericAPICall({
		...
		data: '<GetServices xmlns=\\\"http://ws.qliktech.com/QMS/11/\\\"><serviceTypes>All</serviceTypes></GetServices>'
	},callback);	
}
...
QVEDX.prototype.GetTasks = function(options,callback){
	QVEDX.prototype.GenericAPICall({
		soapAction: 'GetTasks',
		data: '<GetTasks xmlns=\\\"http://ws.qliktech.com/QMS/11/\\\"><qdsID>00000000-0000-0000-0000-000000000000</qdsID></GetTasks>'
	},callback);	
}
...
QVEDX.prototype.GetCALConfiguration = function(options,callback){
	...
	QVEDX.prototype.GenericAPICall({
		...
		data: '<GetCALConfiguration xmlns=\\\"http://ws.qliktech.com/QMS/11/\\\"><qvsID>'+options.qvsID+'</qvsID><scope>All</scope></GetCALConfiguration>'
	},callback);
}
...
QVEDX.prototype.GetUserDocuments = function(options,callback){
	...
	QVEDX.prototype.GenericAPICall({
		...
		data: '<GetUserDocuments xmlns="http://ws.qliktech.com/QMS/11/">'+options.qvsID+'</qvsID></GetUserDocuments>'
	},callback);
}
...
/*
<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/"><s:Body><GetTaskStatusNodes xmlns="http://ws.qliktech.com/QMS/11/"><taskStatusNodeRequests xmlns:a="http://schemas.datacontract.org/2004/07/PIX.QMSAPI.DataObjects" xmlns:i="http://www.w3.org/2001/XMLSchema-instance"><a:TaskStatusNodeRequest><a:CategoryName>CPS Pricing</a:CategoryName><a:ID>00000000-0000-0000-0000-000000000000</a:ID><a:QDSID>00000000-0000-0000-0000-000000000000</a:QDSID><a:RootType>Category</a:RootType><a:TaskID>00000000-0000-0000-0000-000000000000</a:TaskID><a:UseFlatTaskList>false</a:UseFlatTaskList></a:TaskStatusNodeRequest></taskStatusNodeRequests><filter i:nil="true" xmlns:a="http://schemas.datacontract.org/2004/07/PIX.QMSAPI.DataObjects" xmlns:i="http://www.w3.org/2001/XMLSchema-instance"/><scope>All</scope></GetTaskStatusNodes></s:Body></s:Envelope>
*/
}
